...
[null, 1, 2, 3, 3]
    ...
    recent_counter_1 = RecentCounter()
    test(recent_counter_1.ping(1), 1)
    test(recent_counter_1.ping(100), 2)
    test(recent_counter_1.ping(3001), 3)
    test(recent_counter_1.ping(3002), 3)
