...
if __name__ == "__main__":
    ...
    test(solution.removeDuplicates([]), 0)
    test(solution.removeDuplicates([3]), 1)
    test(solution.removeDuplicates([3,3]), 2)
    test(solution.removeDuplicates([1,1,1,2,2,3]), 5)
    test(solution.removeDuplicates([0,0,1,1,1,1,2,3,3]), 7)
