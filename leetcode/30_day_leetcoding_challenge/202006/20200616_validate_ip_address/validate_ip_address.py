...
Write a function to check whether an input string is a
...
by colons (":"). For example, the address 2001:0db8:85a3:0000:0000:8a2e:0370:7334 is
a valid one. Also, we could omit some leading zeros among four hexadecimal
...
if __name__ == "__main__":
    ...
    test(solution.validIPAddress("172.16.254.1"), "IPv4")
    test(solution.validIPAddress("2001:0db8:85a3:0:0:8A2E:0370:7334"), "IPv6")
    test(solution.validIPAddress("256.256.256.256"), "Neither")
