...
if __name__ == "__main__":
    ...
    test(solution.maxUncrossedLines([1,4,2], [1,2,4]), 2)
    test(solution.maxUncrossedLines([2,5,1,2,5], [10,5,2,1,5,2]), 3)
    test(solution.maxUncrossedLines([1,3,7,1,7,5], [1,9,2,5,1]), 2)
    test(solution.maxUncrossedLines([2,1], [1,2,1,3,3,2]), 2)
    test(solution.maxUncrossedLines([1,1,2,1,2], [1,3,2,3,1]), 3)
