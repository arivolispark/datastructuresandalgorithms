...
class Solution:
    def removeElement(self, nums: List[int], val: int) -> int:
        ...
        while low <= high:
            ...
            if low <= high and nums[low] == val and nums[high] != val:
...
if __name__ == "__main__":
    ...
    test(solution.removeElement([3,2,2,3], 3), 2)
    test(solution.removeElement([0,1,2,2,3,0,4,2], 2), 5)
    test(solution.removeElement([2,2,3], 2), 1)
