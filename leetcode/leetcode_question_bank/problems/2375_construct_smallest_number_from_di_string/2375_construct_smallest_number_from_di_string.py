...
class Solution:
    ...
    def smallestNumber(self, pattern: str) -> str:
        ...
        for c in pattern:
            ...
            if c == 'I':
                while stack:
                    max_so_far = max(max_so_far, stack[-1])
                    result.append(stack.pop())
            stack.append(chr(ord(max_so_far) + 1))
...
if __name__ == "__main__":
    ...
    test(solution.smallestNumber("IIIDIDDD"), "123549876")
    test(solution.smallestNumber("DDD"), "4321")
