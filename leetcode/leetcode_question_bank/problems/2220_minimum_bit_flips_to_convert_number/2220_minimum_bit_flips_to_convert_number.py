...
any leading zeros not shown) and flip it. We can flip the first bit from the right to get 110, flip
...
if __name__ == "__main__":
    ...
    test(solution.minBitFlips(10, 7), 3)
    test(solution.minBitFlips(3, 4), 3)
